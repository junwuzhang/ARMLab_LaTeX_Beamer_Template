...
\frametitle{Introduction}
	...
	\begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{June_2020_ARMLab/images/prob_formulation_scenario_1.png}
...
\begin{frame}{Example of Horizontal Subfigures}
	...
	\begin{figure}
		...
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{June_2020_ARMLab/images/stone2014fall_setup.png}
			\caption{Single Kinect setup for fall prevention in elderly residence \cite{stone2014fall}}
		\end{subfigure}%
		~ 
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{June_2020_ARMLab/images/staranowicz2015easy_multiple_kinects.png}
...
\begin{frame}{Example of Horizontal Alignment}
    ...
    \vspace{0pt}
    \centering
    \includegraphics[width=0.7\textwidth]{June_2020_ARMLab/images/waist_cam_setup_new.png}
    \end{minipage}
    \end{center}
\end{frame}
...
\frametitle{Example of Video}
	...
	addresource=June_2020_ARMLab/images/opensim_video.mp4,
	flashvars={
		%important: same path as in `addresource'
		source=June_2020_ARMLab/images/opensim_video.mp4
	}
